...
useRouteMatch is used when you want to use Route, without using the origin. It matches the origin to the rest of the route

2. How would you explain form validation to someone who has never programmed before?

Form validation is the red error you get then something is not filled in when you fill out your forms. You will normally see it with an circle and and x, with the error

3. In 1-2 sentences, define end to end testing.

End to end testing looks at the enter website. It test your whole site to make sure there are no bugs
